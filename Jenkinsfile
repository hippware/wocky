node {
  try {
    ...
    mail bcc: '', body: 'Build ID failed for ${JOB_NAME}. See output at ', cc: '', from: 'noreply@jenkins.dev.tinyrobot.com', replyTo: '', to: 'bernard@hippware.com', subject: 'Jenkins build FAILED for '
