defmodule Wocky.Repo.Migration.Utils do
  ...
  defdelegate update_notify(table, actions, overrides \\ []),
    to: DawdleDB.Migration

  defdelegate remove_notify(table, actions), to: DawdleDB.Migration
  ...
  @spec add_notify(binary, Event.action() | [Event.action()], [override]) ::
          term
