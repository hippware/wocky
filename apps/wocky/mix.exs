defmodule Wocky.Mixfile do
  ...
  defp deps do
    [
      ...
      {:dataloader, "~> 1.0.0"},
      {:dawdle, "~> 0.7"},
      # TODO: Move back to main hex version of dawdle_db once postgrex 0.15.3 is released
      {:dawdle_db, "~> 0.7", organization: "hippware"},
      {:distillery, "~> 2.0"},
      {:ecto_enum, "~> 1.4"},
      {:ecto_sql, "~> 3.2", organization: "hippware", override: true},
      {:elixometer, "~> 1.3"},
      {:email_checker, "~> 0.1"},
      {:eventually, "~> 1.0"},
      {:ex_aws, "~> 2.0"},
      ...
      {:plug, "~> 1.0"},
      {:plug_cowboy, "~> 2.0"},
      {:postgrex, "~> 0.15", organization: "hippware", override: true},
      {:prometheus_ecto, "~> 1.4"},
      {:prometheus_ex, "~> 3.0"},
