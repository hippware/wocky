...
Benchee.run(
  %{
    ...
    bots_10: fn l -> GeoFence.check_for_bot_events(l, bots_10) end,
    bots_100: fn l -> GeoFence.check_for_bot_events(l, bots_100) end,
    bots_1000: fn l -> GeoFence.check_for_bot_events(l, bots_1000) end
  },
